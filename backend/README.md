...
## Project Structure
    ...
    ├── testapiautosetting_123002  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_123002`
...
2. Clone this repo and `cd testapiautosetting_123002`
